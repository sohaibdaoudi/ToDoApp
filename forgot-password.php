        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="forgot-password.php" method="POST" autocomplete="off">
                    ...
                    <p class="text-center text">Please enter your email address and your backup code to update your password</p>
                    <?php
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="check-code" value="Continue">
                    </div>
                </form>
            </div>
        </div>
